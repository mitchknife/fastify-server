...
export function createHttpClient({
  fetch,
  baseUri,
}: IHttpClientOptions): IConformanceApi {
...
class ConformanceApiHttpClient implements IConformanceApi {
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IGetApiInfoResponse>;
      }
      return { value: value };
    });
  }
  ...
  public getWidgets(
    ...
    const query: string[] = [];
    request.query == null ||
      query.push("q=" + encodeURIComponent(request.query));
    if (query.length) {
      uri = uri + "?" + query.join("&");
    }
    const fetchRequest: IFetchRequest = {
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IGetWidgetsResponse>;
      }
      return { value: value };
    });
  }
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<ICreateWidgetResponse>;
      }
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IGetWidgetResponse>;
      }
      let headerValue: string | null | undefined;
      headerValue = result.response.headers.get("eTag");
      if (headerValue != null) {
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IDeleteWidgetResponse>;
      }
      return { value: value };
    });
  }
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IGetWidgetBatchResponse>;
      }
      return { value: value };
    });
  }
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IMirrorFieldsResponse>;
      }
      return { value: value };
    });
  }
  ...
  public checkQuery(
    ...
    const query: string[] = [];
    request.string == null ||
      query.push("string=" + encodeURIComponent(request.string));
    request.boolean == null ||
      query.push("boolean=" + request.boolean.toString());
    request.double == null ||
      query.push("double=" + encodeURIComponent(request.double.toString()));
    request.int32 == null || query.push("int32=" + request.int32.toString());
    request.int64 == null || query.push("int64=" + request.int64.toString());
    request.decimal == null ||
      query.push("decimal=" + request.decimal.toString());
    request.enum == null || query.push("enum=" + request.enum);
    request.datetime == null ||
      query.push("datetime=" + encodeURIComponent(request.datetime));
    if (query.length) {
      uri = uri + "?" + query.join("&");
    }
    const fetchRequest: IFetchRequest = {
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<ICheckQueryResponse>;
      }
      return { value: value };
    });
  }
  ...
  public checkPath(
    ...
    const uriPartString =
      request.string != null && encodeURIComponent(request.string);
    if (!uriPartString) {
      return Promise.resolve(createRequiredRequestFieldError("string"));
    }
    const uriPartBoolean =
      request.boolean != null && request.boolean.toString();
    if (!uriPartBoolean) {
      return Promise.resolve(createRequiredRequestFieldError("boolean"));
    }
    const uriPartDouble =
      request.double != null && encodeURIComponent(request.double.toString());
    if (!uriPartDouble) {
    ...
    const uriPartDecimal =
      request.decimal != null && request.decimal.toString();
    if (!uriPartDecimal) {
    ...
    const uriPartDatetime =
      request.datetime != null && encodeURIComponent(request.datetime);
    if (!uriPartDatetime) {
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<ICheckPathResponse>;
      }
      return { value: value };
    });
  }
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IMirrorHeadersResponse>;
      }
      let headerValue: string | null | undefined;
  ...
  public mixed(
    ...
    const uriPartPath =
      request.path != null && encodeURIComponent(request.path);
    if (!uriPartPath) {
    ...
    const query: string[] = [];
    request.query == null ||
      query.push("query=" + encodeURIComponent(request.query));
    if (query.length) {
      uri = uri + "?" + query.join("&");
    }
    const fetchRequest: IFetchRequest = {
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IMixedResponse>;
      }
      let headerValue: string | null | undefined;
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IRequiredResponse>;
      }
      return { value: value };
    });
  }
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IMirrorBytesResponse>;
      }
      let headerValue: string | null | undefined;
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IMirrorTextResponse>;
      }
      let headerValue: string | null | undefined;
      headerValue = result.response.headers.get("Content-Type");
      if (headerValue != null) {
    ...
    return fetchResponse(
      ...
      if (!value) {
        return createResponseError(
          status,
          result.json
        ) as IServiceResult<IBodyTypesResponse>;
      }
      return { value: value };
    });
  }
